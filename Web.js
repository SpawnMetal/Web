...
{//#Flux-архитектура
	...
	{//#MobX
		...
		runInAction(fn)
		Используйте эту утилиту для создания временного действия, которое вызывается немедленно. Может быть полезен в асинхронных процессах. Посмотрите приведенный выше блок кода для примера.
	}
}
