...
{//#Контекст (Контекст выполнения) #Context (execution context))
	...
	#Стрелочные функции не создают свой контекст. call не поможет. Можно получить замкнутый this, а не контекст родителя, например obj1.obj2.arrow() в arrow не будет ссылаться на obj1.this, а например obj1.obj2.function(arrow()) будет. См пример
	...
	{//#Scope
		...
		Функции, создаваемые через new Function, имеют значением [[Scope]] не внешний объект переменных, а window. См #new
...
{//#Flux-архитектура #State #Manager #Менеджер #Состояний
	...
	{//#MobX
		...
		runInAction(fn)
		Используйте эту утилиту для создания временного действия, которое вызывается немедленно. Может быть полезен в асинхронных процессах.
...
{//#Типы данных
	...
	{//#Object #Объект #Массив #Array
		...
		https://itchef.ru/articles/125551/#:~:text=%D0%A1%D0%B2%D1%8F%D0%B7%D0%B0%D0%BD%D0%BD%D1%8B%D0%B9%20%D1%81%D0%BF%D0%B8%D1%81%D0%BE%D0%BA%20%E2%80%94%20%D1%8D%D1%82%D0%BE%20%D1%82%D0%B8%D0%BF%20%D1%81%D1%82%D1%80%D1%83%D0%BA%D1%82%D1%83%D1%80%D1%8B,%D0%B5%D1%81%D1%82%D1%8C%20%D1%83%D0%BA%D0%B0%D0%B7%D0%B0%D1%82%D0%B5%D0%BB%D1%8C%20%D0%BD%D0%B0%20%D0%BF%D1%80%D0%B5%D0%B4%D1%8B%D0%B4%D1%83%D1%89%D0%B8%D0%B9%20%D1%83%D0%B7%D0%B5%D0%BB.
...
{//#Typescript
	...
	TypeScript - TypeScript — это строго типизированный язык программирования, основанный на JavaScript. Средство разработки веб-приложений, расширяющее возможности JavaScript. Компилятор TypeScript называется tsc. Код компилируется в JavaScript. От разраба C#.
