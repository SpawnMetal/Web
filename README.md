...
Каждый объект имеет прототип от наследуемого **proto**. В ES5 Object.getPrototypeOf()

Через свойство prototype можно добавлять и изменять параметры

prototype - прототип текущего класса, а **proto** - родительского

Например, Object.prototype существует, а obj = {}, obj.prototype не существует. Object.prototype === obj.**proto**
