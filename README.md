...
- Т.е. Раздельный интерфейс (React). В классе должны быть только актуальные методы, которые могут быть добавлены в класс позже.
...
В CSS ::before создает псевдоэлемент, который является `первым` дочерним элементом выбранного элемента. Он часто используется для добавления косметического содержимого к элементу со contentсвойством. Он встроен по умолчанию.

`::after` https://developer.mozilla.org/en-US/docs/Web/CSS/::after

В CSS ::after создает псевдоэлемент, который является `последним` дочерним элементом выбранного элемента. Он часто используется для добавления косметического содержимого к элементу со contentсвойством. Он встроен по умолчанию.
